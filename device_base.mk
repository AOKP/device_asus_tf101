...
# Sound
PRODUCT_COPY_FILES += \
    device/asus/tf101/etc/media_codecs.xml:system/etc/media_codecs.xml \
    device/asus/tf101/etc/mixer_paths.xml:system/etc/mixer_paths.xml \
	device/asus/tf101/etc/audio_policy.conf:system/etc/audio_policy.conf
